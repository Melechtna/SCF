...
const SLRightImage = document.getElementById('sl-right');
const SRRightImage = document.getElementById('sr-right');
...
// Function to update SR Right button state
function updateSRRightButton(isPressed) {
    if (isPressed) {
        SRRightImage.src = 'images/Pushed/SRR.png';
    } else {
        SRRightImage.src = 'images/Buttons/SRR.png';
    }
}

// Function to update SL Right button state
function updateSLRightButton(isPressed) {
    if (isPressed) {
        SLRightImage.src = 'images/Pushed/SLR.png';
    } else {
        SLRightImage.src = 'images/Buttons/SLR.png';
    }
}
...
function checkGamepad() {
    ...
    if (gamepad) {
        ...
        if (vendorId === desiredVendorId && productId === desiredProductId) {
            ...
            // Check Right stick
            const RightxAxisValue = gamepad.axes[0];
            const RightyAxisValue = gamepad.axes[1];
            ...
            // Check right bumper
            const rightBumperValue = gamepad.buttons[8].pressed;
            ...
            // Check X button
            const isXButtonPressed = gamepad.buttons[1].pressed;
            ...
            // Check SR Right button
            const isSRRightPressed = gamepad.buttons[5].pressed;
            updateSRRightButton(isSRRightPressed);

            // Check SL Right button
            const isSLRightPressed = gamepad.buttons[4].pressed;
            updateSLRightButton(isSLRightPressed);
        }
    }
